{% macro create_aws_avalanche_api() %}
    ...
    {% elif target.name == "dev" %}
        {% set sql %}
        CREATE api integration IF NOT EXISTS aws_avalanche_api_sbx_shah api_provider = aws_api_gateway api_aws_role_arn = 'arn:aws:iam::579011195466:role/snowflake-api-avalanche' api_allowed_prefixes = (
