...
WITH unwrap AS (
    ...
    SELECT
        ...
        contract_address,
        topic_0,
        '0xeb1bb70123b2f43419d070d7fde5618971cc2f8f' AS bridge_address,
        'avalanche-bridge' AS platform,
        event_name,
        event_index,
    ...
    WHERE
        contract_address NOT IN ('0x152b9d0fdc40c096757f570a51e494bd4b943e50')
