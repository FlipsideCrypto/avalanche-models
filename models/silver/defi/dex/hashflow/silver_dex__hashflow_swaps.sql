...
SELECT
    ...
    tx_to,
    CASE
        WHEN token_in = '0x0000000000000000000000000000000000000000' THEN '0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7'
        ELSE token_in
    END AS token_in,
    CASE
        WHEN token_out = '0x0000000000000000000000000000000000000000' THEN '0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7'
        ELSE token_out
    END AS token_out,
    amount_in_unadj,
    amount_out_unadj,
