...
WITH swaps_base AS (
    ...
    SELECT
        ...
        CONCAT('0x', SUBSTR(l_segmented_data [1] :: STRING, 25, 40)) AS tokenIn,
        CONCAT('0x', SUBSTR(l_segmented_data [2] :: STRING, 25, 40)) AS tokenOut,
        TRY_TO_NUMBER(
    ...
    FROM
        ...
        l
    WHERE
        contract_address = '0x5f719c2f1095f7b9fc68a68e35b51194f4b6abe8'
