...
WITH logs_pull AS (
    ...
    WHERE
        ...
        OR tx_hash = '0x5d2dc069f3f129d7f93b479644a3f58a87952bbd66ab465bf7013e5d5ca727aa'
...
FROM
    logs_pull
WHERE
    tx_hash = '0x5d2dc069f3f129d7f93b479644a3f58a87952bbd66ab465bf7013e5d5ca727aa'
UNION ALL
SELECT
    tx_hash,
    block_number,
