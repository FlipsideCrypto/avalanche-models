...
WITH settings AS (
    ...
    SELECT
        ...
        '2022-10-21 03:41:33.000' AS end_date,
        '0x18cd9270dbdca86d470cfb3be1b156241fffa9de' AS main_address,
        '0x47cf44fc310baaafd2408a24cff43c6f51889edf' AS fee_address,
        '0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7' AS wrapped_native_address
),
raw AS (
    SELECT
        tx_hash,
